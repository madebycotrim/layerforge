...
export default function CardOrcamento({ item, onClick }) {
    ...
    return (
        <div
            onClick={onClick}
            className="group relative flex flex-col justify-between w-full h-[200px] bg-zinc-950/40 border border-zinc-800/50 rounded-2xl p-6 hover-lift cursor-pointer overflow-hidden transition-all duration-300 hover:border-zinc-700"
        >
            {/* Header: Status e ID */}
            ...
            <div className="flex items-end justify-between pt-4 border-t border-zinc-900/50">
                ...
                <div className="
                    w-8 h-8 rounded-xl bg-zinc-900 border border-zinc-800 flex items-center justify-center 
