        ...
        return (
            <div className="bg-zinc-950/40 border border-zinc-800/50 rounded-2xl p-6 hover-lift flex flex-col justify-between group h-full">
                ...
                <button
                    ...
                    className="mt-6 w-full py-3 rounded-xl bg-zinc-900 border border-zinc-800 text-[10px] font-black uppercase text-zinc-400 hover:text-white hover:bg-zinc-800 transition-all flex items-center justify-center gap-2"
                >
