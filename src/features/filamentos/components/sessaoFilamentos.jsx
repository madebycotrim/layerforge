            ...
            <div className="flex items-center gap-6 group">
                ...
                >
                    ...
                    <div className={`p-2.5 rounded-xl border transition-all duration-300 flex items-center justify-center ${
                        isOpen 
                        ? 'bg-zinc-900 border-zinc-800 text-sky-400 shadow-[inset_0_0_10px_rgba(14,165,233,0.1)]' 
                ...
                <div className={`h-px flex-1 transition-all duration-700 ${isOpen ? 'bg-zinc-800/60' : 'bg-zinc-900/20'} mx-2`} />

                {/* Métricas do Painel (Exibição de dados) */}
                <div className="flex items-center gap-6 px-5 py-2 rounded-2xl bg-zinc-900/40 border border-zinc-800/50 backdrop-blur-md shadow-sm select-none">
            ...
            {isOpen && (
                ...
                >
                    {listaItens.length > 0 ? (
                        ...
                        <div className="col-span-full py-16 flex flex-col items-center justify-center border border-dashed border-zinc-800/50 rounded-[2rem] bg-zinc-900/5">
