            ...
            <div className={`relative bg-zinc-950 border border-zinc-800/80 rounded-[2rem] w-full max-w-5xl shadow-2xl overflow-hidden flex flex-col md:flex-row max-h-[96vh] modal-content ${isSaving ? 'opacity-90 grayscale-[0.3]' : 'opacity-100'}`}>
                ...
                <div className="flex-1 flex flex-col bg-zinc-950">
                    <header className="px-10 py-6 border-b border-zinc-800/50 bg-zinc-900/10 flex justify-between items-center">
                        ...
                        <button disabled={isSaving} onClick={handleTentativaFechar} className="p-2 rounded-full hover:bg-zinc-900 text-zinc-500 transition-all disabled:opacity-30">
                            <X size={20} />
                        </button>
                    </header>
                    ...
                    <div className={`p-10 overflow-y-auto custom-scrollbar flex-1 space-y-8 ${isSaving ? 'pointer-events-none' : ''}`}>
                            ...
                            <div className="grid grid-cols-2 gap-x-8 gap-y-5">
                                <div className="space-y-1.5">
                                    <div className="flex justify-between items-center px-1">
                                        ...
                                        <button onClick={() => setManualEntry(p => ({ marca: !p.marca }))} className="text-[9px] text-sky-500/70 hover:text-sky-400 transition-colors font-bold uppercase tracking-tighter">
                        ...
                        <section className="space-y-5">
                            ...
                            <div className="p-6 bg-zinc-900/20 border border-zinc-800/50 rounded-2xl space-y-5">
