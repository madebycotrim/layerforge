...
export default function ModalBaixaRapida({ aberto, aoFechar, item, aoSalvar }) {
    ...
    const handleTentativaFechar = useCallback(() => {
        ...
        if (consumo !== "" && consumo !== "0") {
            if (window.confirm("Você já informou o consumo. Quer mesmo cancelar a baixa?")) {
                aoFechar();
            }
        } else {
            aoFechar();
                ...
                <div className="flex-1 flex flex-col bg-zinc-950">
                    ...
                    <div className={`p-10 overflow-y-auto custom-scrollbar flex-1 space-y-8 ${isSaving ? 'pointer-events-none opacity-50' : ''}`}>
                        ...
                        <section className="space-y-4">
                            ...
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    placeholder="0.00"
                                    className={`w-full bg-zinc-900/50 border rounded-2xl py-6 pl-14 pr-24 text-4xl font-bold text-zinc-100 outline-none transition-all shadow-inner font-mono ${erroSaldoNegativo ? 'border-rose-500/40 focus:border-rose-500/60 ring-4 ring-rose-500/5' : 'border-zinc-800 focus:border-zinc-600 focus:bg-zinc-900'}`}
                                />
                            ...
                            <div className="grid grid-cols-5 gap-3">
                                {[10, 25, 50, 100, 250].map(val => (
                                    <button
                                        ...
                                        className="py-2.5 bg-zinc-900 border border-zinc-800 hover:border-zinc-500 text-[10px] font-bold text-zinc-500 hover:text-zinc-100 rounded-xl transition-all active:scale-95 uppercase tracking-widest disabled:opacity-30"
                                    >
                                        +{val}g
                                    </button>
                                ))}
                        ...
                        <section className="space-y-4">
                            ...
                            <div className="p-6 bg-zinc-900/20 border border-zinc-800/50 rounded-[1.5rem] space-y-5">
