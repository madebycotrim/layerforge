...
/**
 * generateProfessionalPDF - Relatório de Engenharia e Custos
 * @param {Object} resultados - Dados vindos do motor de cálculo
 * @param {Object} entradas - Estado do formulário
 * @param {Number} precoFinalExibido - O preço que o usuário está vendo (incluindo arredondamentos manuais)
 */
