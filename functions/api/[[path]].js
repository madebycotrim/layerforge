...
export async function onRequest(context) {
    ...
    try {
        ...
        await db.batch([
            ...
            db.prepare(`CREATE TABLE IF NOT EXISTS calculator_settings (user_id TEXT PRIMARY KEY, custo_kwh REAL, valor_hora_humana REAL, custo_hora_maquina REAL, taxa_setup REAL, consumo_impressora_kw REAL, margem_lucro REAL, imposto REAL, taxa_fail REAL, desconto REAL, whatsapp_template TEXT)`),
        ...
        // Injeção de dependências para os módulos
        const ctx = { request, db, userId, pathArray, url: new URL(request.url) };
